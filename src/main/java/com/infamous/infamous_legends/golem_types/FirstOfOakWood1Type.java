...
public class FirstOfOakWood1Type {
    public static final Codec<FirstOfOakWood1Type> CODEC = RecordCodecBuilder.create(builder ->
            builder.group(
            ...
            ).apply(builder, FirstOfOakWood1Type::new));
    ...
    public FirstOfOakWood1Type(Block planks, String name, String textureLocation, String glowTextureLocation) {
        this.planks = planks;
        this.name = name;
