...
public class PiglinBruiserAi {

	  public static Brain<?> makeBrain(PiglinBruiser p_35100_, Brain<PiglinBruiser> p_35101_) {
	   ...
	   public static void initMemories(PiglinBruiser p_35095_) {
	   ...
	   private static void initCoreActivity(PiglinBruiser p_35112_, Brain<PiglinBruiser> p_35113_) {
	   ...
	   private static void initIdleActivity(PiglinBruiser p_35120_, Brain<PiglinBruiser> p_35121_) {
	      p_35121_.addActivity(Activity.IDLE, 10, ImmutableList.of(new StartAttacking<>(PiglinBruiserAi::findNearestValidAttackTarget), createIdleLookBehaviors(), createIdleMovementBehaviors(), new SetLookAndInteract(EntityType.PLAYER, 4)));
	   }
	   ...
	   private static RunOne<PiglinBruiser> createIdleLookBehaviors() {
		   ...
		   private static RunOne<PiglinBruiser> createIdleMovementBehaviors() {
	   ...
	   public static void updateActivity(PiglinBruiser p_35110_) {
	      Brain<PiglinBruiser> brain = p_35110_.getBrain();
	   ...
	   public static void maybePlayActivitySound(PiglinBruiser p_35115_) {
	   ...
	   private static void playActivitySound(PiglinBruiser p_35123_) {
