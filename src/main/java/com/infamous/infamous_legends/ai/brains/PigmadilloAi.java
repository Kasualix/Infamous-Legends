...
import com.infamous.infamous_legends.ai.brains.behaviours.PigmadilloMeleeAttack;
import com.infamous.infamous_legends.ai.brains.behaviours.PigmadilloRollAttack;
...
public class PigmadilloAi {

	  public static Brain<?> makeBrain(Pigmadillo p_35100_, Brain<Pigmadillo> p_35101_) {
	   ...
	   public static void initMemories(Pigmadillo p_35095_) {
	   ...
	   private static void initCoreActivity(Pigmadillo p_35112_, Brain<Pigmadillo> p_35113_) {
	   ...
	   private static void initIdleActivity(Pigmadillo p_35120_, Brain<Pigmadillo> p_35121_) {
	      p_35121_.addActivity(Activity.IDLE, 10, ImmutableList.of(new StartAttacking<>(PigmadilloAi::findNearestValidAttackTarget), createIdleLookBehaviors(), createIdleMovementBehaviors(), new SetLookAndInteract(EntityType.PLAYER, 4)));
	   }

	   private static void initFightActivity(Pigmadillo p_35125_, Brain<Pigmadillo> p_35126_) {
	      ...
	      }), new SetWalkTargetFromAttackTargetIfTargetOutOfReach(1.0F), new PigmadilloMeleeAttack(20), new PigmadilloRollAttack(200), new LookAtAttackTarget()), MemoryModuleType.ATTACK_TARGET);
	   }

	   private static RunOne<Pigmadillo> createIdleLookBehaviors() {
		   ...
		   private static RunOne<Pigmadillo> createIdleMovementBehaviors() {
	   ...
	   public static void updateActivity(Pigmadillo p_35110_) {
	      Brain<Pigmadillo> brain = p_35110_.getBrain();
	   ...
	   public static void maybePlayActivitySound(Pigmadillo p_35115_) {
	   ...
	   private static void playActivitySound(Pigmadillo p_35123_) {
