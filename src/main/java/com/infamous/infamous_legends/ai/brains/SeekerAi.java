...
public class SeekerAi {
	  ...
	  public static Brain<?> makeBrain(Seeker p_35100_, Brain<Seeker> p_35101_) {
	   ...
	   public static void initMemories(Seeker p_35095_) {
	   ...
	   private static void initCoreActivity(Seeker p_35112_, Brain<Seeker> p_35113_) {
	   ...
	   private static void initFightActivity(Seeker p_35125_, Brain<Seeker> p_35126_) {
	      ...
	      }), new SetWalkTargetFromAttackTargetIfTargetOutOfReach(1.0F), new SeekerMeleeAttack(20), new LookAtAttackTarget()), MemoryModuleType.ATTACK_TARGET);
	   }

	   private static RunOne<Seeker> createIdleLookBehaviors() {
	   ...
	   public static void updateActivity(Seeker p_35110_) {
	      Brain<Seeker> brain = p_35110_.getBrain();
	   ...
	   public static void wasHurtBy(Seeker p_35097_, LivingEntity p_35098_) {
		      BrainUtils.piglinMaybeRetaliate(p_35097_, p_35098_);
	   }

	   protected static void setAngerTarget(Seeker p_149989_, LivingEntity p_149990_) {
	   ...
	   public static void maybePlayActivitySound(Seeker p_35115_) {
	   ...
	   private static void playActivitySound(Seeker p_35123_) {
