...
public class PortalGuardAi {

	  public static Brain<?> makeBrain(PortalGuard p_35100_, Brain<PortalGuard> p_35101_) {
	   ...
	   public static void initMemories(PortalGuard p_35095_) {
	   ...
	   private static void initCoreActivity(PortalGuard p_35112_, Brain<PortalGuard> p_35113_) {
	   ...
	   private static void initIdleActivity(PortalGuard p_35120_, Brain<PortalGuard> p_35121_) {
	      p_35121_.addActivity(Activity.IDLE, 10, ImmutableList.of(new StartAttacking<>(PortalGuardAi::findNearestValidAttackTarget), createIdleLookBehaviors(), createIdleMovementBehaviors(), new SetLookAndInteract(EntityType.PLAYER, 4)));
	   }
	   ...
	   private static void initFightActivity(PortalGuard p_35125_, Brain<PortalGuard> p_35126_) {
	      ...
	      }), new SetWalkTargetFromAttackTargetIfTargetOutOfReach(1.0F), new PortalGuardMeleeAttack(10), new PortalGuardSwingAttack(200), new PortalGuardShootAttack(300), new LookAtAttackTarget()), MemoryModuleType.ATTACK_TARGET);
	   }
	   ...
	   private static RunOne<PortalGuard> createIdleLookBehaviors() {
		   ...
		   private static RunOne<PortalGuard> createIdleMovementBehaviors() {
	   ...
	   public static void updateActivity(PortalGuard p_35110_) {
	      Brain<PortalGuard> brain = p_35110_.getBrain();
	   ...
	   public static void wasHurtBy(PortalGuard p_35097_, LivingEntity p_35098_) {
		      BrainUtils.piglinMaybeRetaliate(p_35097_, p_35098_);
	   }

	   protected static void setAngerTarget(PortalGuard p_149989_, LivingEntity p_149990_) {
	   ...
	   public static void maybePlayActivitySound(PortalGuard p_35115_) {
	   ...
	   private static void playActivitySound(PortalGuard p_35123_) {
