...
import com.infamous.infamous_legends.ai.brains.behaviours.SporebackThrowAttack;
...
public class SporebackAi {
	  ...
	  public static Brain<?> makeBrain(Sporeback p_35100_, Brain<Sporeback> p_35101_) {
	   ...
	   public static void initMemories(Sporeback p_35095_) {
	   ...
	   private static void initCoreActivity(Sporeback p_35112_, Brain<Sporeback> p_35113_) {
	   ...
	   private static void initIdleActivity(Sporeback p_35120_, Brain<Sporeback> p_35121_) {
	      p_35121_.addActivity(Activity.IDLE, 10, ImmutableList.of(new StartAttacking<>(SporebackAi::findNearestValidAttackTarget), createIdleLookBehaviors(), createIdleMovementBehaviors(), new SetLookAndInteract(EntityType.PLAYER, 4)));
	   }
	   ...
	   private static RunOne<Sporeback> createIdleMovementBehaviors() {
	   ...
	   public static void updateActivity(Sporeback p_35110_) {
	      Brain<Sporeback> brain = p_35110_.getBrain();
	   ...
	   public static void wasHurtBy(Sporeback p_35097_, LivingEntity p_35098_) {
		      BrainUtils.piglinMaybeRetaliate(p_35097_, p_35098_);
	   }

	   protected static void setAngerTarget(Sporeback p_149989_, LivingEntity p_149990_) {
	   ...
	   public static void maybePlayActivitySound(Sporeback p_35115_) {
	   ...
	   private static void playActivitySound(Sporeback p_35123_) {
