...
public class RegalTigerPounceAttackGoal extends Goal {
		...
		public void tick() {
			...
			if (target != null && mob.attackAnimationTick < mob.attackAnimationActionPoint && mob.attackAnimationTick >= mob.attackAnimationLength - 17 && mob.distanceTo(target) <= mob.getBbWidth() / 2) {
