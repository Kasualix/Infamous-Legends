...
@OnlyIn(Dist.CLIENT)
public class PlayerPortalGuardWreckingBallRenderer extends EntityRenderer<PlayerPortalGuardWreckingBall> {
	
	private static final ResourceLocation CHAIN_LOCATION = new ResourceLocation(InfamousLegends.MOD_ID, "textures/items/portal_guard_flail.png");
	private static final RenderType CHAIN_RENDER_TYPE = RenderType.entityCutoutNoCull(CHAIN_LOCATION);
	   
   private final PlayerPortalGuardWreckingBallModel model;

   public PlayerPortalGuardWreckingBallRenderer(EntityRendererProvider.Context p_174420_) {
      super(p_174420_);
      this.model = new PlayerPortalGuardWreckingBallModel(p_174420_.bakeLayer(ModelLayerInit.PLAYER_PORTAL_GUARD_WRECKING_BALL));
   }

   public void render(PlayerPortalGuardWreckingBall p_116111_, float p_116112_, float p_116113_, PoseStack p_116114_, MultiBufferSource p_116115_, int p_116116_) {
      p_116114_.pushPose();
   ...
   private <E extends LivingEntity> void renderChain(PlayerPortalGuardWreckingBall p_115462_, float p_115463_, PoseStack p_115464_, MultiBufferSource p_115465_, E p_115466_) {
	      p_115464_.pushPose();
	      Vec3 vec3 = PositionUtils.getOffsetPos(p_115466_, 0.5, 1, 0, p_115466_.yBodyRot);
   ...
   public ResourceLocation getTextureLocation(PlayerPortalGuardWreckingBall p_116109_) {
      return new ResourceLocation(InfamousLegends.MOD_ID, "textures/items/portal_guard_flail.png");
   }
}