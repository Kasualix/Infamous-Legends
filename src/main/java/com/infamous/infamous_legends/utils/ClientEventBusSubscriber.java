...
import com.infamous.infamous_legends.renderers.BadgerRenderer;
...
public class ClientEventBusSubscriber {
    ...
    public static void onRegisterLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event){
        ...
        event.registerLayerDefinition(ModelLayerInit.BADGER, BadgerModel::createBodyLayer);
	...
	public static void registerRenderers(final EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(EntityTypeInit.BADGER.get(), BadgerRenderer::new);
